...
1. Run ``docker_build.sh`` to create the Docker image with Dockerfile (``Dockerfile_22.04``) and Dockertag (``qcom-6.6.136-qli.1.9-ver.1.0_22.04``). Use this Docker image to create the container environment and run the Yocto build.
...
#. Sync and build the Yocto image in a Docker container with the Docker
   ...
   .. container:: nohighlight
      ...
      ::
         ...
         bash docker/docker_run.sh -t qcom-6.6.136-qli.1.9-ver.1.0_22.04 -r qcom-6.6.136-QLI.1.9-Ver.1.0 -M <machine> --build-override <override> --alternate-repo true
         # Example, bash docker/docker_run.sh -t qcom-6.6.136-qli.1.9-ver.1.0_22.04 -r qcom-6.6.136-QLI.1.9-Ver.1.0 -M qcs6490-rb3gen2-vision-kit --build-override custom --alternate-repo true
   ...
   For example,
   ``qcom-download-utils/qcom-6.6.136-QLI.1.9-Ver.1.0/build-qcom-wayland``.
...
#. Build Qualcomm IM SDK on top of the base image using Docker:
   ...
   a. Run the following commands inside the base image build location:
      ...
      .. container:: nohighlight
         ...
         ::
            ...
            cd <workspace_path>/qcom-download-utils/qcom-6.6.136-QLI.1.9-Ver.1.0
            bash
            docker run -it -v "${HOME}/.gitconfig":"/home/${USER}/.gitconfig" -v "${HOME}/.netrc":"/home/${USER}/.netrc" -v $(pwd):$(pwd) -w $(pwd) qcom-6.6.136-qli.1.9-ver.1.0_22.04 /bin/bash
   ...
   #. Set up the build environment:
      ...
      For the ``MACHINE`` parameter values, see `Release Notes <https://docs.qualcomm.com/doc/80-70030-300/>`__.
...
1. List the Docker images:
   ...
   .. container:: screenoutput
       ...
       qcom-6.6.136-qli.1.9-ver.1.0_22.04                        latest                      8fcea388d8ca   2 days ago     1.47GB
...
#. Run the following commands outside the Docker container:
   ...
   .. container:: nohighlight
      ...
      ::
         ...
         # Example
         WORKSPACE=<workspace_path>/qcom-download-utils/qcom-6.6.136-QLI.1.9-Ver.1.0
