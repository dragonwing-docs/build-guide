...
This section provides sample workspace structures with ``qsc-cli`` and GitHub workflow standalone use cases, for the supported `hardware SoCs <https://docs.qualcomm.com/bundle/publicresource/topics/80-70030-115/soc.html>`__.
...
.. list-table:: 
   ...
   * - ``efi.bin``
     - EFI system partition image. For more information, see `Qualcomm Linux Yocto Guide <https://https://docs.qualcomm.com/bundle/publicresource/topics/80-70030-27/managing_partitions_in_qualcomm_linux.html#linux-operating-system-partitions>`__.
   * - ``qdl``
