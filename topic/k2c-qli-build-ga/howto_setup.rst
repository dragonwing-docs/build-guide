...
Connect to ADB
^^^^^^^^^^^^^^^^
See `Install and connect to ADB <https://docs.qualcomm.com/bundle/publicresource/topics/80-70030-251/faqs.html#install-adb>`__.
...
.. note:: 
   ...
   - To create a non-root user account, see `Create a non-root user account <https://docs.qualcomm.com/bundle/publicresource/topics/80-70030-251/faqs.html#non-root-acc>`__.
