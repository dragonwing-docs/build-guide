...
2. Flash the software with the default configuration.
   ...
   #. Select :guilabel:`Done`.
      ...
      .. note:: The device reboots after the flashing procedure completes successfully. To verify the updated software version, see `Verify the Qualcomm Linux version <https://docs.qualcomm.com/bundle/publicresource/topics/80-70030-251/set_up_the_device.html#verify-the-qualcomm-linux-version>`__.
