...
Qualcomm Linux uses Yocto to build an embedded system software image. Hence, Qualcomm recommends that you read the `Qualcomm Linux Yocto Guide <https://docs.qualcomm.com/bundle/publicresource/topics/80-70030-27>`__ before starting your build. You can do any of the following:
...
- In the `Release Notes <https://docs.qualcomm.com/doc/80-70030-300/topic/prebuilt_flashable_images_along_with_esdk.html>`__, go to the *Artifactory links to prebuilt flashable images and eSDK* table to download prebuilt flashable images and the Platform eSDK.
...
.. note:: 
   ...
   - See `Hardware SoCs <https://docs.qualcomm.com/bundle/publicresource/topics/80-70030-115/soc.html>`__ that are supported on Qualcomm Linux.
