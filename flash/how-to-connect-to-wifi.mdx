...
- Check the connection and device status
   ...
   nmcli -p device
   ```
   ![status_of_devices](./media/k2c-qli-build-ga/status_of_devices.png)

- Check the WLAN connection status and IP address
   ```bash
   ip address show wlp1s0
   ```
   ![chk_ip](./media/k2c-qli-build-ga/chk_ip.png)
...
- Check the disconnect status
   ...
   nmcli -p device
   ```
   ![status_of_devices_switch_network](./media/k2c-qli-build-ga/status_of_devices_switch_network.png)
