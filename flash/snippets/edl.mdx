...
<Tabs>
  <Tab title="QCS6490/QCS5430">
    - Press and hold the **F_DL** button.
     ![Figure: RB3Gen2_device](/Key-Documents/Build-Guide/media/k2c-qli-build-ga/RB3Gen2_device.png)
    ...
    <Tabs>
      <Tab title="IQ-9 Beta Evaluation Kit (EVK)">
        - Put the device in EDL mode by turning on the dip switch S5-4.
          ![Figure: qcs9075_qdl_mode_manual](/Key-Documents/Build-Guide/media/k2c-qli-build-ga/qcs9075_qdl_mode_manual.png)
      ...
      <Tab title="IQ-9075 EVK">
        - Put the device in EDL mode by turning on the dip switch SW2-3.
          ![Figure: IQ_9075_EVK](/Key-Documents/Build-Guide/media/k2c-qli-build-ga/IQ_9075_EVK.png)
  ...
  <Tab title="IQ-615">
    - Put the device in EDL mode by turning off the SW switch and turning on the dip switch SW3-4.
      ![Figure: qcs615_qdl_mode_manual](/Key-Documents/Build-Guide/media/k2c-qli-build-ga/qcs615_qdl_mode_manual.png)
